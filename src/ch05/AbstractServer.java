...
public abstract class AbstractServer {
	...
	protected abstract void setupServer() throws IOException; // 추상 메서드

	// 2. 클라이언트 연결 대기 실행(구현 클래스에서 직접 설계)
	protected abstract void connection() throws IOException; // 추상 메서드

	// 3. 스트림 초기화(연결된 소켓에서 스트림을 뽑아야 한다) - 여기서 한다(private)
